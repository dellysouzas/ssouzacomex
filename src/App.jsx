...
function App() {
    ...
    const handleClick = (e) => {
      ...
      if (target) {
        ...
        if (text.toLowerCase().includes("orçamento")) {
          ...
          text.toLowerCase().includes("serviços") ||
          text.toLowerCase().includes("servicos")
        ) {
          e.preventDefault();
          scrollToServices();
        }
  ...
  const services = [
    {
      id: "desembaraço-com-due",
      name: "Desembaraço Aduaneiro com emissão de DUE",
    },
    {
      id: "desembaraço-sem-due",
      name: "Desembaraço Aduaneiro sem emissão de DUE",
    },
  ...
  // Função para converter valores das opções para textos completos
  const getDisplayText = (field, value) => {
    switch (field) {
      case "operationType":
        return value === "exportacao"
          ? "Exportação"
          : value === "importacao"
          ? "Importação"
          : value === "ambos"
          ? "Ambos (Exportação e Importação)"
          : value;
      case "frequency":
        return value === "primeira-vez"
          ? "Primeira vez"
          : value === "ocasional"
          ? "Ocasional (2-3x por ano)"
          : value === "regular"
          ? "Regular (mensal)"
          : value === "intensivo"
          ? "Intensivo (semanal)"
  ...
  const handleSubmit = async () => {
    try {
      // Preparar os dados para envio com textos completos
      const payload = {
        ...formData,
        // Converter selectedServices de IDs para nomes completos
        selectedServices: formData.selectedServices.map((serviceId) => {
          const service = services.find((s) => s.id === serviceId);
          return service ? service.name : serviceId;
        }),
        // Converter todos os campos de opções para textos completos
        operationType: getDisplayText("operationType", formData.operationType),
        frequency: getDisplayText("frequency", formData.frequency),
        budget: getDisplayText("budget", formData.budget),
        timeline: getDisplayText("timeline", formData.timeline),
        source: getDisplayText("source", formData.source),
        timestamp: new Date().toISOString(),
        source: "Website Souza Comex",
      };

      // Enviar dados para o webhook
      const response = await fetch(
        "https://n8n.sysigreja.com/webhook/3bf673f9-1b3d-4af9-af60-a7aa415a8fd0",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        alert(
          "Solicitação enviada com sucesso! Em até 24 horas entraremos em contato."
        );
      ...
      alert(
        "Erro ao enviar a solicitação. Por favor, tente novamente ou entre em contato conosco."
      );
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container-custom">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <nav className="hidden lg:flex space-x-8 xl:space-x-10">
              <a
                href="#inicio"
                className="text-primary-500 hover:text-primary-600 transition-all duration-300 font-medium relative group"
              >
                Início
          ...
          {/* Mobile Navigation */}
          <div
            className={`lg:hidden overflow-hidden mobile-menu-transition ${
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M14.017 21v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"
                    />
                  </svg>
                  Depoimentos
                </a>
      ...
      <main className="pt-16 sm:pt-20">
        ...
        <section
          id="inicio"
          className="section-padding bg-gradient-to-br from-primary-50 via-white to-secondary-50"
        >
          <div className="container-custom">
              ...
              <div className="text-left space-y-8">
                <div className="space-y-6">
                  ...
                  <h2 className="text-2xl lg:text-3xl font-semibold leading-relaxed">
                    ...
                    <span className="custom-blue font-bold">destino</span>
                  </h2>
                </div>
                ...
                <p className="text-lg lg:text-xl text-primary-600 leading-relaxed max-w-2xl">
                  ...
                  no mercado, somos sua parceira confiável para todas as
                  operações de comércio exterior. Agilidade, follow-up
                  personalizado e maturidade no segmento.
                </p>
                ...
                <div className="md:hidden pt-8">
                  ...
                  <div className="mobile-cta-card bg-white border-2 border-primary-200 rounded-2xl p-6 shadow-xl transform hover:scale-[1.02] transition-all duration-300 active:scale-95">
                    ...
                    <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                      Descubra todas as soluções que oferecemos para seu
                      comércio exterior
                    </p>
                    <button
        ...
        <section
          id="sobre"
          className="section-padding bg-gradient-to-br from-white via-primary-50 to-secondary-50"
        >
          <div className="container-custom">
            {/* Chamada Atraente */}
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-primary-600 max-w-3xl mx-auto leading-relaxed">
                De uma <span className="font-bold text-primary-700">visão</span>{" "}
                a uma{" "}
                <span className="font-bold text-primary-700">realidade</span> de
                sucesso no comércio exterior
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-primary-600 leading-relaxed">
                    Profissional que atua no setor de exportação há{" "}
                    <span className="font-bold text-primary-700">23 anos</span>.
                    Tendo como ponto de partida a expertise de Silvana, a
                    experiência da{" "}
                    <span className="font-bold text-primary-700">
                      S Souza Comex
                    </span>{" "}
                    no comércio exterior é madura, reconhecida e marcada pela
                    prestação de serviço para grandes players do mercado.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <p className="text-lg text-primary-600 leading-relaxed">
                    A nossa trajetória é de{" "}
                    <span className="font-bold text-primary-700">ascensão</span>
                    , com resultados reconhecidos por pequenas e grandes
                    empresas, processos seguros e desburocratizados.
                  </p>
                  ...
                  <div className="bg-primary-50 p-6 rounded-xl border-l-4 border-primary-500">
                    ...
                    <p className="text-primary-600">
                      ...
                      <span className="font-bold">registro de processos</span>,
                      <span className="font-bold"> desembaraços</span> e{" "}
                      <span className="font-bold">
                        coordenação de atividades aduaneiras
                      </span>
              ...
              <div className="relative">
                <div className="relative z-10">
                  <div className="w-full h-96 lg:h-[500px] bg-gradient-to-br from-primary-400 to-primary-600 rounded-3xl shadow-2xl overflow-hidden">
                    <img
                      src="/sil no escritorio.png"
                      alt="Silvana Nascimento - Fundadora da Souza Comex"
                      className="w-full h-full object-cover"
                    />
                  </div>
                </div>
        ...
        <section
          id="servicos"
          className="section-padding bg-gradient-to-br from-secondary-50 via-white to-primary-50"
        >
          <div className="container-custom">
            {/* Header da Seção */}
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-primary-600 max-w-3xl mx-auto leading-relaxed">
                ...
                para todas as suas necessidades de comércio exterior
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-bold text-primary-600 leading-tight">
                        Desembaraço Aduaneiro com emissão de DUE
                      </h3>
                    </div>
                  </div>
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Preparação e registro da Declaração Única de Exportação,
                    garantindo que toda a documentação esteja correta e o
                    processo ocorra sem atrasos.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico1-details")
                ...
                <div
                  id="servico1-details"
                  className="hidden bg-gradient-to-r from-primary-50 to-secondary-50 p-8 border-t border-primary-200"
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que realizam exportações regulares e
                    precisam atender às exigências do Portal Único de Comércio
                    Exterior.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-bold text-primary-600 leading-tight">
                        Desembaraço Aduaneiro sem emissão de DUE
                      </h3>
                    </div>
                  </div>
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Atendimento ágil para operações em que a emissão da
                    Declaração Única de Exportação é feita pelo próprio cliente,
                    garantindo que o restante do processo ocorra de forma rápida
                    e em conformidade com as normas.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico2-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que já possuem equipe interna ou
                    parceiro para emitir a DUE, mas precisam de suporte
                    especializado no desembaraço aduaneiro.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Planejamento e execução de exportações por tempo
                    determinado, assegurando a correta documentação para
                    posterior retorno da mercadoria.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico3-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que enviam produtos para feiras,
                    exposições, testes ou consertos no exterior e precisam que
                    retornem ao país sem incidência de tributos de importação.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Coordenação e acompanhamento de carga em portos e
                    aeroportos, garantindo manuseio seguro e cumprimento dos
                    prazos de embarque e desembarque.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico4-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que necessitam de suporte operacional
                    local para embarques e desembarques, especialmente quando
                    não possuem equipe própria no terminal.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Cotação, contratação e acompanhamento de embarques aéreos
                    para garantir agilidade e segurança no transporte.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico5-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que precisam enviar mercadorias de
                    forma rápida, urgente ou com alto valor agregado.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Organização do transporte terrestre entre países,
                    assegurando logística integrada e rastreamento.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico6-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que exportam ou importam para países
                    vizinhos via transporte terrestre, como Argentina, Paraguai,
                    Chile e outros da América do Sul.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Coordenação de envios marítimos com parceiros de confiança,
                    buscando o melhor custo-benefício.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico7-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que enviam grandes volumes ou cargas
                    de alto peso, buscando otimizar custos logísticos.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Assessoria na obtenção e gestão do regime especial que reduz
                    ou isenta tributos para insumos importados destinados à
                    exportação.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico8-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas industriais ou comerciais que
                    importam insumos para produzir mercadorias destinadas à
                    exportação, visando redução de custos tributários.
                  </p>
                </div>
              </div>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed mb-6">
                    Processos de entrada de mercadorias no país com suspensão de
                    tributos para uso específico e por prazo determinado.
                  </p>
                  <button
                    onClick={() =>
                      document
                        .getElementById("servico9-details")
                        .classList.toggle("hidden")
                    }
                    className="group/btn btn-modern"
                  >
                ...
                >
                  <p className="text-primary-600 text-base leading-relaxed">
                    Indicado para empresas que trazem equipamentos, máquinas ou
                    produtos para eventos, feiras, testes, exposições ou obras
          ...
          <div className="container-custom">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-primary-600 max-w-4xl mx-auto leading-relaxed">
                Nossa{" "}
                <span className="custom-blue font-semibold">expertise</span> e
                compromisso fazem a diferença em cada operação de comércio
                exterior
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 text-center leading-relaxed">
                  Atendimento direto e personalizado com uma profissional
                  experiente, sem intermediários.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:custom-blue-shadow">
                ...
                <p className="text-gray-600 text-center leading-relaxed">
                  Compromisso com prazos e rapidez na execução de todas as
                  operações.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <p className="text-gray-600 text-center leading-relaxed">
                  Conhecimento prático e experiência com diferentes mercados
                  internacionais.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:custom-blue-shadow">
                ...
                <p className="text-gray-600 text-center leading-relaxed">
                  Facilidade no processo burocrático, tornando o comércio
        ...
        >
          <div className="container-custom">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-primary-600 max-w-3xl mx-auto leading-relaxed">
                <span className="font-bold text-primary-700">Confiança</span> e{" "}
                <span className="font-bold text-primary-700">resultados</span>{" "}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  <blockquote className="text-gray-700 text-lg leading-relaxed mb-6 italic">
                    "A Souza Comex transformou completamente nossa experiência
                    de exportação. A agilidade e profissionalismo da equipe nos
                    permitiu expandir para novos mercados com total confiança. O
                    follow-up personalizado faz toda a diferença!"
                  </blockquote>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  {/* Texto do depoimento */}
                  <blockquote className="text-gray-700 text-lg leading-relaxed mb-6 italic">
                    "Após 15 anos no mercado, posso dizer que a Souza Comex é
                    uma das empresas mais competentes que já trabalhei. A
                    experiência da Silvana e a maturidade no segmento são
                    evidentes em cada operação. Recomendo sem hesitar!"
                  </blockquote>
              ...
              <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden transform hover:-translate-y-2">
                <div className="p-8">
                  ...
                  {/* Texto do depoimento */}
                  <blockquote className="text-gray-700 text-lg leading-relaxed mb-6 italic">
                    "Como empresa que começou pequena, precisávamos de um
                    parceiro que entendesse nossas necessidades. A Souza Comex
                    não só entendeu, como superou todas as expectativas.
                    Processos desburocratizados e resultados excepcionais!"
                  </blockquote>
            ...
            <div className="text-center mt-16">
              <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl p-8 shadow-2xl">
                ...
                <p className="text-primary-100 text-lg mb-6 max-w-2xl mx-auto">
                  Junte-se aos clientes que já transformaram suas operações de
                  comércio exterior com a Souza Comex
                </p>
                <button
          ...
          <div className="container-custom">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-primary-600 max-w-3xl mx-auto leading-relaxed">
                ...
                e descubra como podemos otimizar suas operações de comércio
                exterior
              </p>
            </div>
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-6">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                          Selecione quais serviços você gostaria de contratar
                        </p>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {services.map((service, index) => (
                          <label
                            key={index}
                            className="flex items-center p-4 border border-gray-200 rounded-xl cursor-pointer hover:border-primary-300 transition-all duration-300"
                          >
                            <input
                              type="checkbox"
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                          Nos conte mais sobre suas necessidades
                        </p>
                      </div>
                  ...
                  {currentStep === 4 && (
                    <div className="space-y-6">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                          Últimas informações para personalizar sua proposta
                        </p>
                      </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Frequência:{" "}
                            {getDisplayText("frequency", formData.frequency)}
                          </p>
                          <p className="text-gray-600">
                            Produtos: {formData.products}
                          </p>
                          <p className="text-gray-600">
                            Destinos: {formData.destinations}
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Orçamento:{" "}
                            {getDisplayText("budget", formData.budget)}
                          </p>
                          <p className="text-gray-600">
                            Prazo:{" "}
                            {getDisplayText("timeline", formData.timeline)}
                          </p>
                          <p className="text-gray-600">
                            Como conheceu:{" "}
                            {getDisplayText("source", formData.source)}
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-blue-700 text-sm">
                              ...
                              para agendar uma reunião personalizada e
                              apresentar sua proposta comercial sob medida.
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1 text-center sm:text-left">
              ...
              <p className="text-primary-100 leading-relaxed mb-6 text-sm md:text-base">
                Mais de 23 anos de experiência no comércio exterior, oferecendo
                soluções completas e personalizadas para suas operações de
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="space-y-3 md:space-y-4 text-primary-100 text-sm md:text-base">
                <div className="flex items-start gap-3 justify-center sm:justify-start">
                  <svg
                    className="w-5 h-5 text-primary-300 mt-1 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="space-y-3 md:space-y-4 text-primary-100 text-sm md:text-base">
                ...
                <div>
                  ...
                  <p>31.052.976/0001-31</p>
                </div>

                <div>
                  <p className="font-medium">Fundadora</p>
                  <p>Silvana Nascimento</p>
                </div>

                <div>
                  <p className="font-medium">Experiência</p>
                  <p>+23 anos no mercado</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container-custom py-6">
            <div className="text-center">
              <div className="text-primary-200 text-sm">
                © 2025 Souza Comex. Todos os direitos reservados.
              </div>
            </div>
          </div>
        </div>
